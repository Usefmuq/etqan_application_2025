class ServicesManagersPageView {
  final String? servicesmanagerId;
  final String? createdById;
  final DateTime? servicesmanagerUpdatedAt;
  final String? status;
  final bool? isActive;
  final String? title;
  ...
  ServicesManagersPageView({
    this.servicesmanagerId,
    this.title,
    this.content,
    this.status,
    this.isActive,
    this.topics,
    this.servicesmanagerUpdatedAt,
    this.createdById,
    this.fullNameEn,
    this.fullNameAr,
    this.email,

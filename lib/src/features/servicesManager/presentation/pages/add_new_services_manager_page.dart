...
class AddNewServicesManagerPage extends StatefulWidget {
  const AddNewServicesManagerPage({super.key});
  static route() => MaterialPageRoute(
        builder: (context) => const AddNewServicesManagerPage(),
      );
  @override
  State<AddNewServicesManagerPage> createState() =>
      _AddNewServicesManagerPageState();
}

class _AddNewServicesManagerPageState extends State<AddNewServicesManagerPage> {
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
      title: AppLocalizations.of(context)!.servicesManagerSubmitNew,

      showDrawer: false,
      // tilteActions: [
      //   IconButton(
      //     onPressed: _submitServicesManager,
      ...
      body: [
        BlocConsumer<ServicesManagerBloc, ServicesManagerState>(
          listener: (context, state) {
            ...
            } else if (state is ServicesManagerSubmitSuccess) {
              WidgetsBinding.instance.addPostFrameCallback((_) {

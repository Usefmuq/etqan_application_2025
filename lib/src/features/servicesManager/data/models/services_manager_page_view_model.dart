// servicesmanagers_page_view_model.dart

import 'package:etqan_application_2025/src/features/servicesManager/domain/entities/services_manager.dart';
import 'package:etqan_application_2025/src/features/servicesManager/domain/entities/services_managers_page_view.dart';

class ServicesManagersPageViewModel extends ServicesManagersPageView {
  ServicesManagersPageViewModel({
    super.servicesmanagerId,
    super.title,
    super.content,
    super.status,
    super.isActive,
    super.topics,
    super.servicesmanagerUpdatedAt,
    super.createdById,
    super.fullNameEn,
    super.fullNameAr,
    super.email,
  ...
  ServicesManagersPageViewModel copyWith({
    String? servicesmanagerId,
    String? createdById,
    DateTime? servicesmanagerUpdatedAt,
    String? status,
    bool? isActive,
    String? title,
    String? content,
    ...
    return ServicesManagersPageViewModel(
      servicesmanagerId: servicesmanagerId ?? this.servicesmanagerId,
      createdById: createdById ?? this.createdById,
      servicesmanagerUpdatedAt:
          servicesmanagerUpdatedAt ?? this.servicesmanagerUpdatedAt,
  ...
  factory ServicesManagersPageViewModel.fromJson(Map<String, dynamic> json) {
    return ServicesManagersPageViewModel(
      servicesmanagerId: json['id'],
      title: json['title'],
      content: json['content'],
      status: json['status'],
      isActive: json['is_active'],
      topics: json['topics'] != null ? List<String>.from(json['topics']) : null,
      servicesmanagerUpdatedAt: json['servicesmanager_updated_at'] != null
          ? DateTime.tryParse(json['servicesmanager_updated_at'])
          : null,
  ...
  ServicesManager? toServicesManager() {
    return ServicesManager(
      id: servicesmanagerId ?? "",
      createdById: createdById ?? "",
      updatedAt: servicesmanagerUpdatedAt ??

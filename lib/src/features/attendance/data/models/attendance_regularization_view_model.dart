...
class AttendanceRegularizationViewModel
  ...
  factory AttendanceRegularizationViewModel.fromJson(
    ...
    return AttendanceRegularizationViewModel(
      ...
      proposedCheckIn: dt(json['proposed_check_in']),
      proposedCheckOut: dt(json['proposed_check_out']),
      reason: json['reason'] ?? '',
      status: json['status'],
  ...
  Map<String, dynamic> toJson() {
    ...
    return {
      ...
      'proposed_check_in': ts(proposedCheckIn),
      'proposed_check_out': ts(proposedCheckOut),
      'reason': reason,
      'status': status,

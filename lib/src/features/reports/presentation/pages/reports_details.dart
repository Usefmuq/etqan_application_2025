...
//   if (reportsViewerPage == null) return const SizedBox.shrink();

//   final l10n = AppLocalizations.of(context)!;
//   final view = reportsViewerPage.reportssView;
...
//     children: [
//       CustomSectionTitle(title: l10n.reportDetails),
//       CustomKeyValueGrid(
//         data: {
//           l10n.title: view.title ?? '—',
//           l10n.requestId: "${l10n.report}-${view.requestId ?? '—'}",
...
//           // If reportsUpdatedAt is a DateTime, format it; if it's already a string, show it.
//           l10n.updatedAt: view.reportsUpdatedAt is DateTime
//               ? fmt(view.reportsUpdatedAt as DateTime)
//               : (view.reportsUpdatedAt?.toString() ?? '—'),

...
// class AddNewReportsPage extends StatefulWidget {
//   const AddNewReportsPage({super.key});
//   static route() => MaterialPageRoute(
//         builder: (context) => const AddNewReportsPage(),
//       );
//   @override
//   State<AddNewReportsPage> createState() => _AddNewReportsPageState();
// }

// class _AddNewReportsPageState extends State<AddNewReportsPage> {
...
//       title: AppLocalizations.of(context)!.reportSubmitNew,
...
//                 );
//               });
//             } else if (state is ReportsSubmitSuccess) {
//               WidgetsBinding.instance.addPostFrameCallback((_) {
